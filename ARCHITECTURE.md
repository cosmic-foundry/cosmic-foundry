...
1. Add `LinearOperatorDescriptor` construction for small assembled operators and
   ...
   truth for ownership.
2. Derive projected atlas geometry from schema predicates instead of manual plot
...
3. Add an interactive atlas projection mode.  The generated documentation should
