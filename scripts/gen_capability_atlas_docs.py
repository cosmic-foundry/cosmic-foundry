...
def render_capability_atlas() -> str:
    ...
    lines = [
        ...
        "that preserve schema-cell source information.  Each plot names the axes",
        "shown directly, the coordinates fixed outside the projection, and the",
        "higher-dimensional axes that are only summarized.  Region geometry is",
        "drawn first; concrete",
