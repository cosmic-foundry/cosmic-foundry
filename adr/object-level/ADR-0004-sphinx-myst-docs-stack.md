...
Cosmic Foundry's object-level roadmap ([`roadmap/implementation/README.md`](../../roadmap/implementation/README.md),
["Documentation"](../../roadmap/implementation/epoch-00-bootstrap.md) §0.5) commits to
