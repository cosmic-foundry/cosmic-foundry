...
- [Object-level architecture](object-level.md) — what the platform and
...
- [Meta-level architecture](meta-level.md) — how the project verifies and
...
| ADR | Primary concern |
|-----|-----------------|
| [ADR-0001](ADR-0001-python-with-runtime-codegen.md) | Python-only engine with runtime code generation |
| [ADR-0002](ADR-0002-jax-primary-kernel-backend.md) | JAX + XLA as primary kernel backend |
| [ADR-0003](ADR-0003-jax-distributed-host-parallelism.md) | `jax.distributed` host parallelism |
| [ADR-0004](ADR-0004-sphinx-myst-docs-stack.md) | Sphinx + MyST-NB documentation stack |
| [ADR-0006](ADR-0006-visualization-stack.md) | Visualization and science-communication stack |
| [ADR-0009](ADR-0009-float64-default-precision.md) | Float64 default precision |
| [ADR-0010](ADR-0010-kernel-abstraction-model.md) | Kernel abstraction model |
| [ADR-0011](ADR-0011-halo-fill-fence.md) | Halo fill fence |
| [ADR-0012](ADR-0012-global-reduction-primitive.md) | Global reduction primitive |
| [ADR-0014](ADR-0014-platform-application-architecture.md) | Platform / application repository architecture |

### Meta-Level ADRs

| ADR | Primary concern |
|-----|-----------------|
| [ADR-0005](ADR-0005-branch-pr-attribution-discipline.md) | Branch, PR, history, and attribution discipline |
| [ADR-0007](ADR-0007-replication-workflow.md) | Bounded-increment replication workflow |
| [ADR-0008](ADR-0008-numerical-transcription-discipline.md) | Numerical-transcription discipline stub |
| [ADR-0013](ADR-0013-derivation-first-lane.md) | Derivation-first lane for physics capabilities |
| [ADR-0015](ADR-0015-reproducibility-meta-generator.md) | Reproducibility meta-generator |
