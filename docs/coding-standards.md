...
- Every new capability needs a test. See
  [ADR-0007](../adr/ADR-0007-replication-workflow.md) for the
  verification-first discipline applied to numerical capabilities.
...
[AI.md](../AI.md) for the full guideline (exemptions for generated files,
documentation, and pure scaffolding).
